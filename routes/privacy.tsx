    ...
    <>
      ...
      <Section>
        <div class="font-zodiak max-w-3xl">
          <H variant="h3" class="text-2xl font-medium mb-8 uppercase font-clash-display">Datenschutz­erklärung</H>
          <H variant="h4" class="text-xl font-medium mb-4 uppercase font-clash-display">1. Datenschutz auf einen Blick</H>
          ...
          <H variant="h4" class="text-xl font-medium mb-4 uppercase font-clash-display">2. Datenerfassung auf dieser Website</H>
          <p class="mb-8 font-medium italic">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</p>
          <p class="mb-12">
