...
function validatePrintRequest(form: FormData): RequestMessage {
  ...
  return {
    type: "success",
    text:
      `Anfrage ${requestId} ist eingegangen. Ich pruefe Datei, Materialwahl und Fertigungsaufwand als naechstes.`,
  };
}
    ...
    <>
      ...
      <section class="shell py-16">
        <div class="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          <div>
            <p class="eyebrow text-[var(--clay)]">Druckanfrage</p>
            <h1 class="display mt-5 text-5xl font-semibold md:text-7xl">
              Modellpruefung und Fertigungsangaben.
            </h1>
          </div>
          <p class="max-w-2xl text-xl leading-8">
            Laden Sie STL, STEP/STP oder 3MF in den Viewer und ergaenzen Sie
            Material, Finish, Toleranzen und Einsatzzweck. Die Angaben dienen
            als Grundlage fuer eine technische Einschaetzung vor dem Druck.
          </p>
        </div>
          ...
          <div class="grid content-start gap-5">
            ...
            <div class="card p-5">
              ...
              <div class="mt-5 grid gap-3">
                {[
                  "Geometrie und Dateiformat pruefen",
                  "Material, Finish und Druckparameter erfassen",
                  "Rueckmeldung zu Machbarkeit und Aufwand erhalten",
                ].map((item, index) => (
      ...
      <section class="section pt-0">
        <div class="shell grid gap-6 md:grid-cols-3">
          <div class="card p-5">
            ...
            <p class="mt-3">
              Mesh-Dateien fuer schnelle Geometriepruefung, Abmessungen und
              erste Einschaetzung der Druckbarkeit.
            </p>
          </div>
          <div class="card p-5">
            <p class="eyebrow text-[var(--clay)]">STEP / STP</p>
            <p class="mt-3">
              CAD-Dateien sind fuer technische Rueckfragen und Anpassungen oft
              praeziser als reine Mesh-Exporte.
            </p>
          </div>
          <div class="card p-5">
            <p class="eyebrow text-[var(--clay)]">3MF</p>
            <p class="mt-3">
              3MF eignet sich fuer Druckprojekte mit eingebetteten
              Modellinformationen und klarer Angebotsbasis.
            </p>
          </div>
        </div>
      </section>
