...
const Navbar = () => {
  return (
    ...
    <nav class="flex flex-row justify-between px-8 py-4 w-full gap-12 z-10">
      <ul class="text-foreground flex flex-row items-center gap-4">
        <li>
          <IconLogo />
        </li>
      ...
      <ul class="text-foreground md:flex flex-row items-center gap-4 hidden text-sm font-zodiak" // TODO add blend mode
      >
        <li>
          <a href="/">
            home.
